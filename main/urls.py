...
from main.views import main_view,home_view,list_view,listing_view,edit_view,like_listing_view,inquire_listing_using_email
...
urlpatterns = [
    ...
    path('listing/<str:id>/edit/',edit_view,name='edit_view'),
